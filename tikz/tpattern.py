...
## FILENAME_TPATTERN  = Data file generated by RecurGreen containing the rho(T) distribution (Input file, CSV format).
## TITLE              = LaTeX title of the TikZ figure (Input string).
import sys
import os
import compile_tikz

TEMPLATE_TIKZ = "tikz/tpattern.tikz"   ## TikZ template for the "task_tpattern" operation of the RecurGreen program.
